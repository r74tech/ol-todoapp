...
class UserTest < ActiveSupport::TestCase
  ...
  # end
  def setup
    @user = User.new(username: "user", email: 'test@example.com', password: 'password', password_confirmation: 'password')
  end
  ...
  test "検証失敗_email" do
    invalids = %w[user@example,com user_at_foo.org user.username@example.
